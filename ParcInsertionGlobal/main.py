...
def insertion_data(day,site,segment):
    ...
    for r in resultats:
        ...
        age = ""
        age_actuelle = (r['birthday_date'] - day).year
        ...
        if day == datetime(r['last_topup_date'].year,r['last_topup_date'].month,r['last_topup_date'].day):
            insertion['parc_recharge_1j'] = 1
        if calcul_date(day,r['last_topup_date']<30):
            insertion['parc_recharge_30j'] = 1

        day_29_j = day - timedelta(29)
        if (r['last_event_o_date'] <day and r['last_event_o_date']>day_29_j) or (r['last_data_date'] <day and r['last_data_date'] > day_29_j) or (r['last_om_transaction_date']<day and r['last_om_transaction_date']>day_29_j):
